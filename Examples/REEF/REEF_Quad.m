...
% Set Params
params = Parameters();
params.RotorNo = 4; % Number of Rotors
...
params.PropDiameter_Max = 16; % in; IGNORED if useWheelbase
...
params.BattCellNo_Desired = 6; % IGNORED if SelectBattCellNo == false
...
mass_Frame = 550; % Tarot 650 Carbon TL65B01
mass_Computer = 300; % Intel NUC
mass_FC = 20;
mass_Sensors = 300 + 10; % Camera, Sonar
mass_Payload = 4500; % 4500g = 10lbs
