% main.m
% http://gryphondynamics.co.kr/product/y6-airframe-kit-v2
...
params.Wheelbase = 1200/25.41; % in; Diagonal from motor to motor %TODO: include math n paper
...
params.PropDiameter_Min = 21; % in; Smallest size that will be searched
