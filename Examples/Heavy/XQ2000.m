...
params.Wheelbase = 2000/25.41; % in; Diagonal from motor to motor %TODO: include math n paper
...
params.PropDiameter_Max = 36; % in % Largest size; IGNORED if useWheelbase
