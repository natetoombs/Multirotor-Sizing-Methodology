...
params.Wheelbase = 1250/25.41; % in; Diagonal from motor to motor %TODO: include math n paper
params.useOverlap = true; % Allow props to overlap;
params.Overlap = 0.30; % percent; 15% is likely the max safe overlap, and .39% will have the props overlap adjacent motors %TODO cite paper
params.PropDiameter_Min = 15; % in; Smallest size that will be searched
