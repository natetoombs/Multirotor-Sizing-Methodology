...
params.Wheelbase = 1700/25.41; % in; Diagonal from motor to motor %TODO: include math n paper
...
params.PropDiameter_Min = 28; % in; Smallest size that will be searched
params.PropDiameter_Max = 32; % in % Largest size; IGNORED if useWheelbase
...
mass_Frame = 6500;
mass_Computer = 0; % Intel NUC
mass_FC = 20;
mass_Sensors = 0;
mass_Payload = 17000; % 22500g = 50lbs
