...
params.Wheelbase = 1850/25.41; % in; Diagonal from motor to motor %TODO: include math n paper
...
params.PropDiameter_Min = 24; % in; Smallest size that will be searched
...
mass_Frame = 6500; % Estimated weight for JMRRC 1850
